import Bot from "npm:meowerbot";
import { Client, Channel, ChannelCollection } from "npm:revolt.js"; // We need Message and MessageCollection for replies, but that's commented out for now
